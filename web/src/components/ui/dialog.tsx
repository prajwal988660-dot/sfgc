...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'fixed inset-0 z-50 bg-primary-950/60 backdrop-blur-sm',
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'gap-4 rounded-2xl border bg-background p-6 shadow-lift duration-200',
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute right-4 top-4 rounded-full p-1.5 opacity-70 transition-opacity',
