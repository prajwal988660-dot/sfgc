 ...
 *
 * Nothing in here may throw into a caller: a student who declines the
 * permission prompt, or runs the app on a simulator, must still get a working
 * app — they simply do not receive pushes.
 */
